...
const Header = () => {
  return (
    <nav className='flex flex-row justify-between md:bg-purple-950 items-center h-[100px]  bg-white sm:bg-opacity-20 sm:backdrop-blur-lg sm: border rounded-sm '>
      <div className='w-[150px] flex flex-row justify-between md:text-white size-6  font-rammetto ml-4 items-center'>
        <svg className='w-10 h-10 ' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
      ...
      <div className='md:hidden lg:hidden space-x-1 flex flex-row justify-between items-center md:text-white'>
